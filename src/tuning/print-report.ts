...
/**
 * The 1A Division, one Trick a line — where the pacing guards in `pacing.test.ts` place its spine
 * and Mount content against the Auto-Thrower and against each other, read directly rather than
 * cross-referenced against the table above.
 */
